  ...
  return (
    <section className="py-10 bg-lightCyan">
      <div className={` ${styles.boxWidth} ${styles.padding} `}>
        <div
          className={`${layout.section2} about-us ${styles.flexStartB} md:items-center gap-10 md:gap-10`}
        >
          <div>
            <p className={`${styles.caption} mb-3`}>OUR EXPERTISE</p>
            <h2
              className={`${styles.heading2} mb-5 text-[30px] lg:w-[90%] sm:text-[35px] lg:text-[40px] xl:w-[640px] smd:w-[700px] md:w-full  text-black`}
            >
              We want to get local identification in every corner of the world
              in this era of global citizenship
            </h2>
            <p
              className={`${styles.paragraph} text-gray xl:w-[622px] xs:text-[17px] lg:w-[90%] md:w-[] sm:text-[18px] md:text-[16px] smd:w-[650px] md:w-full`}
            >
