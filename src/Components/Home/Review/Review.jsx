import { avatar1, avatar2, avatar3, ipsumCustomer, quote, reviewShape } from "../../../Assets";
        ...
        <section className="py-20 bg-lightPurple">
            <div className={`${styles.boxWidth} ${styles.padding} ${layout.section1} relative items-center justify-between gap-10`}>
                ...
                <div className="review-1">
                    ...
                    <p className={`${styles.paragraphLarge} mb-2 `}>Transform your idea into reality with finsweet</p>
                    <p className={`${styles.paragraph} text-black text-[14px] xs:w-[390px] xl:w-[492px] `}>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. </p>
                ...
                <div className="review-2 bg-white p-10 relative xs:w-[410px] md:w-[507px] lg:w-[607px] md:h-[340px]  xl:p-0 flex items-center justify-center">
                    ...
                    <div>
                        <h4 className={`${styles.heading4} mb-10 xl:w-[498px] md:text-[20px] `}>Finsweet has been a wonderful partner to work with. I have been a customer now for the past few months now and I have had nothing but positive experiences!</h4>
                        <div className="flex flex-col gap-5 xs:flex-row justify-between ">
                            <div className="avatar-title flex items-center gap-3 ">
                                ...
                                <div className="title">
                                    <h6 className={`${styles.heading6} text-[14px]`}>Johnny Andro</h6>
                                    <p className={`${styles.paragraphSmall} text-black text-[12px]`}>Director, Company</p>
                                </div>
                            </div>
                            <div>
