...
const JobDetails = [
  ...
  },
  {
    ...
    name: "Requirements",
    content: [
      "Have adequate knowledge on HTML, CSS, JavaScript",
      "Design & Create highly engaging industry-related content in both photo, gif & video format",      
      "Publish Posts on various social media channels",
      "Promote content on social networks and monitor engagement (e.g. comments and shares)",
      "Research industry-related topics",
...
const Testimonials = [
  {
    ...
    quote: quote,
    avatar: avatar1,
    client: ipsumCustomer,
    name: "Johnny Andro",
    title: "Director, Company",
    content: "Finsweet has been a wonderful partner to work with. I have been a customer now for the past few months now and I have had nothing but positive experiences!",
  },
  {
    id: 2,
    image: reviewShape,
